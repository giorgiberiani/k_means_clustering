...
```bash
    ...
    name, address and date, for other fields I have used python's 'random' library.
    I am using 'Pandas' to read and manipulation on generated dataset and matplotlib
    for data visualization.
    To get optimal number of clusters I am using the “elbow” method, and then train model.
    For training I am using 'scikit-learn' library.
...
```bash
    ...
    daily basis of the  gender -> expertize mapping 
    for Male(Software engineer) Female(Graphics designer)
...
```bash
    ...
    At first it will show graph generated with the “elbow” method, 
    and then trains model on generated dataset.
```
